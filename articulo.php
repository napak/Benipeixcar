  ...
  <div class='row'>
    <div class='col-md-4'>
      <div class='post-side-bar'>
        <div class='widget widget-author'>
          <div class=''>
            <a href="#" class="thumbnail" data-toggle="modal" data-target="#lightbox"><img title="<?php echo $page->articulo_imagen->first()->description ?>" alt='' src='<?php echo $page->articulo_imagen->first()->url ?>' width="340px"></a>
          </div>
    ...
    <div class='col-md-8'>
      <div class='post-single'>
        ...
        <p>
        <?php echo $page->articulo_descripcion ?>
        </p>
