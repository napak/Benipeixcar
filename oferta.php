  ...
  <div class='row'>
    <div class='col-md-4'>
      <div class='post-side-bar'>
        <div class='widget widget-author'>
          <div class=''>
            <a href="#" class="thumbnail" data-toggle="modal" data-target="#lightbox"><img alt='' src='<?php echo $page->oferta_imagen->first()->url ?>' width="340px"></a>
          </div>
    ...
    <div class='col-md-8'>
      <div class='post-single'>
        ...
        <br><br>
      <strong>Fecha límite de validez:</strong> <?php echo $page->oferta_fecha_validez ?>&nbsp;<?php echo $page->oferta_fecha_validez2 ?>
        </p>
