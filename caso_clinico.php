    ...
    <div class='col-md-4'>
      <div class='post-side-bar'>
        <div class='widget widget-author'>
          <div class=''>
            <a href="#" class="thumbnail" data-toggle="modal" data-target="#lightbox"><img title="<?php echo $page->imagen_caso_clinico->first()->description ?>" alt='' src='<?php echo $page->imagen_caso_clinico->first()->url ?>' width="340px"></a>
          </div>
